"""
Train an XGBoost behavior classifier from judge deltas + mech interp.
...
def main():
    parser = argparse.ArgumentParser(description="Train XGBoost behavior classifier")
    parser.add_argument(
        "--judge",
    ...
    parser.add_argument(
        "--out-dir",
        default="classifier_artifacts_xgb",
    ...
    print(f"Training XGBoost (n_estimators={args.n_estimators}, max_depth={args.max_depth})...")
